...
<template>
	<view class="full">
		<!-- 操作按钮 -->
		<!-- 喜欢 -->
		<button class="likeButton margin-top-xl" 
		@click="likePeople()">
		</button>
		<!-- 不喜欢 -->
		<button class="disLikeButton margin-top-xl" 
		 @click="disLikePeople()">
		 </button>
			...
			likePeople(){
				...
				http.post('/like', {},{
					...
					if(res.data.result.sta==1){
						//弹窗
						uni.navigateTo({
							url:`Pair?pairUserId=${THAT.userId}`,
